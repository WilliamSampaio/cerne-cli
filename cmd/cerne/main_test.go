...
func TestCLIContextJSONContract(t *testing.T) {
	...
	expected := "{\n  \"schema_version\": 1,\n  \"status\": \"healthy\",\n  \"workspace\": {\n    \"name\": \"example\",\n    \"root\": \"" + root + "\"\n  },\n  \"knowledge\": {\n    \"path\": \"" + filepath.Join(root, "knowledge") + "\",\n    \"product_path\": \"" + filepath.Join(root, "knowledge", "product") + "\",\n    \"specs_path\": \"" + filepath.Join(root, "knowledge", "specs") + "\",\n    \"decisions_path\": \"" + filepath.Join(root, "knowledge", "decisions") + "\",\n    \"policies_path\": \"" + filepath.Join(root, "knowledge", "policies") + "\"\n  },\n  \"source\": {\n    \"path\": \"" + filepath.Join(root, "source") + "\",\n    \"inside_workspace\": true\n  },\n  \"workflow\": {\n    \"declared\": false,\n    \"state\": \"not-declared\"\n  },\n  \"problems\": []\n}\n"
	if stdout != expected {
