...
- **SC-002**: 100% das execuções sem `--workflow` mantêm manifesto, árvore com os cinco `.gitkeep` obrigatórios, stdout, stderr, status e efeitos observáveis do init vigente na `master` incorporada.
