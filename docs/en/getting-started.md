...
Start with `knowledge/README.md`; it uses the effective `en` or `pt-BR` language and explains the
collections, repository boundaries, and safe inspection commands without depending on a workflow or agent.
