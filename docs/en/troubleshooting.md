...
`erro: pacote oficial cerne-skills ausente ou inacessível` means the Cerne installation does not
include its compatible companion package. Install a complete Cerne distribution before retrying
