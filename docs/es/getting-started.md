...
[seguridad y privacidad](../../README.es.md#seguridad-y-privacidad). Para obtener instrucciones de
recuperación, consulta la [solución de problemas](troubleshooting.md).
